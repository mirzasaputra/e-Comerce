...
$laba = $total['total'] - $hpp['total_hpp'] - (int)$biaya_lain;
...
$pdf->CELL(245, 6, 'BIAYA LAIN', 1, 0, 'L', 1);
$pdf->CELL(35, 6, 'Rp. ' . rupiah($biaya_lain), 1, 1, 'L', 1);
...
$pdf->Output('laporan_laba_bersih.pdf', 'I');
