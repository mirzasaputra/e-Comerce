<div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <div class="box-body">
                <form class="form-retur-beli" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <input type="hidden" class="form-control" id="id-pembelian" name="id-pembelian">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nama-supplier" placeholder="Nama Supplier" readonly>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" id="id-detail-beli" name="id-detail-beli">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="">Harga Jual</label>
                                <input type="text" class="form-control" id="harga-beli" name="harga-beli" placeholder="Harga Beli" readonly>
                            </div>
                        </div>
                        <div class="col-md-1">
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" name="qty-beli" id="qty-beli">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
