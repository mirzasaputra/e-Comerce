...
<div class="box box-success">
    ...
    <div class="box-body chat" id="chat-box">
        <!-- <script src="<?php //echo base_url(); 
                            ?>asset/admin/plugins/highchart/highcharts.js"></script>
        <script src="<?php //echo base_url(); 
                        ?>asset/admin/plugins/highchart/modules/data.js"></script>
        <script src="<?php //echo base_url(); 
                        ?>asset/admin/plugins/highchart/modules/exporting.js"></script> -->
